...
(function (dattoro) {
    var AllPassFilter = (function () {
        function AllPassFilter(ctx, delay, gain, phaseFlip) {
            if (phaseFlip === void 0) { phaseFlip = 1.0; }
            this.delay = delay;
            this.gain = gain;
        ...
        AllPassFilter.prototype.getIn = function () {
            return this._input;
        };
        AllPassFilter.prototype.getFilterOut = function () {
            return this._outputSum;
        };
        AllPassFilter.prototype.getTapOut = function () {
            return this._delay;
        };
...
(function (dattoro) {
    ...
    var LowPassFilter = (function () {
        function LowPassFilter(ctx, gain, invertGain) {
            if (invertGain === void 0) { invertGain = false; }
            this.gain = gain;
            this._input = ctx.createGain();
        ...
        LowPassFilter.prototype.getIn = function () {
            return this._input;
        };
        LowPassFilter.prototype.getOut = function () {
            return this._feedback;
        };
        LowPassFilter.prototype.connectIn = function (node) {
            node.connect(this._input);
        };
        LowPassFilter.prototype.connect = function (node) {
            this._feedback.connect(node);
        };
        return LowPassFilter;
    }());
    dattoro.LowPassFilter = LowPassFilter;
})(dattoro || (dattoro = {}));
/*
